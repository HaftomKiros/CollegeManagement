...
namespace CollegeManagementWPF.Views
{
    public partial class StreamsPage : Page
    {
        ...
        public StreamsPage() { InitializeComponent(); ThemeManager.ThemeChanged += ApplyTheme; ApplyTheme(); ApplyPermissions(); Loaded += async (s,e) => { await LoadDepts(); await Load(Q); }; }
        ...
        private void ApplyPermissions() {
            ...
            Grid1.Visibility     = SessionUser.Has("stream_view")   ? Visibility.Visible : Visibility.Collapsed;
            BtnSave.Visibility   = SessionUser.Has("stream_add")    ? Visibility.Visible : Visibility.Collapsed;
            BtnUpdate.Visibility = SessionUser.Has("stream_update") ? Visibility.Visible : Visibility.Collapsed;
            BtnDelete.Visibility = SessionUser.Has("stream_delete") ? Visibility.Visible : Visibility.Collapsed;
            BtnClear.Visibility  = (SessionUser.Has("stream_add") || SessionUser.Has("stream_update")) ? Visibility.Visible : Visibility.Collapsed;
        }
