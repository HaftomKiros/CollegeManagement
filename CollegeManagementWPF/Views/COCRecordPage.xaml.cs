...
namespace CollegeManagementWPF.Views
{
    public partial class COCRecordPage : Page
    {
        ...
        private void ApplyPermissions()
        {
            ...
            Grid1.Visibility    = SessionUser.Has("coc_view")   ? Visibility.Visible : Visibility.Collapsed;
            BtnSave.Visibility  = SessionUser.Has("coc_add")    ? Visibility.Visible : Visibility.Collapsed;
            BtnUpdate.Visibility= SessionUser.Has("coc_update") ? Visibility.Visible : Visibility.Collapsed;
            BtnDelete.Visibility= SessionUser.Has("coc_delete") ? Visibility.Visible : Visibility.Collapsed;
            BtnClear.Visibility = (SessionUser.Has("coc_add") || SessionUser.Has("coc_update")) ? Visibility.Visible : Visibility.Collapsed;
        }
